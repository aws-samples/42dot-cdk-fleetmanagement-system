    ...
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        let lambdaPreProvisioningHook = new lambda.Function(
            ...
            "-pre-provisioning-hook-lambda",
            {
                ...
                handler: "verify-devices-lambda.lambda_handler",
        ...
        //TODO: Cfn bucket 활용하기
        let cdkTestS3Bucket = new s3.Bucket(this, 'cdkTestS3Bucket', {
            blockPublicAccess: s3.BlockPublicAccess.BLOCK_ALL,
            versioned: true,
            removalPolicy: RemovalPolicy.DESTROY,
            autoDeleteObjects: true,
            bucketName: Config.app.service + "-" + Config.app.environment + "-" + Config.aws.account + "-" + Config.s3BucketName
        });
